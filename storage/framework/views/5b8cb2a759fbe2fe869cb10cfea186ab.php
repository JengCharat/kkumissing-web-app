...
<?php endif; ?>
                ...
                roomID: <?php echo e($userId); ?>

                <br>
                room name: <?php echo e($rooms->roomNumber); ?>

                <h1>======================pay ment======================</h1>
                water_price: <?php echo e($rooms->water_price); ?>

                <br>
                electricity_price: <?php echo e($rooms->electricity_price); ?>



                <br>
                <h1>meter id:<?php echo e($meter_reading->meterID); ?></h1>
                <h1>water_meter_start :<?php echo e($meter_detail->water_meter_start); ?></h1>
                <h1>water_meter_end :<?php echo e($meter_detail->water_meter_end); ?></h1>
                <h1>electricity_meter_start :<?php echo e($meter_detail->electricity_meter_start); ?></h1>
                <h1>electricity_meter_end :<?php echo e($meter_detail->electricity_meter_end); ?></h1>
...
<?php endif; ?>
<?php /**PATH /Users/jengcharat/Desktop/hack/picoCTF/hotel/z/resources/views/dashboard.blade.php ENDPATH**/ ?>